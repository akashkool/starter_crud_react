# CRUD Frontend using React JS

This is the React frontend that goes with the reporisoty <a name="starter_crud_express backend" href="https://github.com/akashkool/starter_crud_express">starter_crud_express</a> backend.
