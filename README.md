...
This is the React frontend that goes with the starter_crud_express backend. It can, however, be used as a starter for any app that features get, post, put and delete requests.
